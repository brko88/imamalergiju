...
const STRINGS = {
  bs: {
    ...
    'scanner.unsupported': 'Ne mogu učitati čitač barkoda (provjeri internet konekciju). Koristi ručni unos ispod.',
    'scanner.cameraError': 'Nije moguće pristupiti kameri. Provjeri dozvole ili koristi ručni unos.',
    'magnifier.openBtn': '🔍 Uveličaj deklaraciju',
    'magnifier.torchOn': '💡 Blic',
    'magnifier.torchOff': '💡 Ugasi blic',
  ...
  en: {
    ...
    'scanner.unsupported': "Couldn't load the barcode reader (check your internet connection). Use manual entry below.",
    'scanner.cameraError': "Can't access the camera. Check permissions or use manual entry.",
    'magnifier.openBtn': '🔍 Zoom in on label',
    'magnifier.torchOn': '💡 Flash',
    'magnifier.torchOff': '💡 Turn off flash',
  ...
  de: {
    ...
    'scanner.unsupported': 'Der Barcode-Scanner konnte nicht geladen werden (Internetverbindung prüfen). Nutze die manuelle Eingabe unten.',
    'scanner.cameraError': 'Kein Zugriff auf die Kamera möglich. Überprüfe die Berechtigungen oder nutze die manuelle Eingabe.',
    'magnifier.openBtn': '🔍 Etikett vergrößern',
    'magnifier.torchOn': '💡 Blitz',
    'magnifier.torchOff': '💡 Blitz aus',
