...
const STRINGS = {
  bs: {
    ...
    'contribute.photoFrontLabel': 'Slika ambalaže/barkoda (obavezno za novi proizvod)',
    'contribute.photoIngredientsLabel': 'Slika deklaracije/sastojaka (obavezno za novi proizvod)',
    ...
    'app.pressBackAgain': 'Pritisni nazad ponovo za izlaz',
    'nav.home': 'Početna',
    'nav.profile': 'Profil',
  ...
  en: {
    ...
    'contribute.photoFrontLabel': 'Photo of packaging/barcode (required for a new product)',
    'contribute.photoIngredientsLabel': 'Photo of ingredients label (required for a new product)',
    ...
    'app.pressBackAgain': 'Press back again to exit',
    'nav.home': 'Home',
    'nav.profile': 'Profile',
    'nav.history': 'History',
  ...
  de: {
    ...
    'contribute.photoFrontLabel': 'Foto der Verpackung/des Barcodes (erforderlich bei neuem Produkt)',
    'contribute.photoIngredientsLabel': 'Foto der Zutatenliste (erforderlich bei neuem Produkt)',
    ...
    'app.pressBackAgain': 'Drücke nochmal zurück zum Beenden',
    'nav.home': 'Start',
    'nav.profile': 'Profil',
    'nav.history': 'Verlauf',
    'share.title': 'imamAlergiju Profil',
